...
export type AdminView = 'DASHBOARD' | 'PINS' | 'ACCESS' | 'EMPLOYEES' | 'ADMIN_MANAGEMENT' | 'PACKING_DATA' | 'PACKING_2_DATA' | 'SORTIR_DATA' | 'PICKER_DATA' | 'PICKER_2_DATA' | 'LEADER_2_DATA' | 'CHECKER_DATA' | 'LOGISTIK_DATA' | 'GUDANG_PENDING' | 'GUDANG_READY' | 'GUDANG_REPORT' | 'GUDANG_BUNDLING' | 'GUDANG_CANCEL' | 'OJOL_DATA' | 'SYMBOLS' | 'SEARCH_ALL' | 'SEARCH_OLD' | 'SEARCH_NEW' | 'SCAN_ALL' | 'FAILED_SCANS' | 'CHECK_INVOICE' | 'FAKE_REPORT' | 'CANCEL_DATA' | 'COMPARE_LOGISTIK' | 'COMPARE_PACKING_PICKER' | 'EXPORT_DATA' | 'BATCH_DATA' | 'BATCH_DATA_2' | 'USER_MONITORING' | 'SUPABASE_CONFIG' | 'SETTINGS' | 'PROFILE_CONFIG' | 'BATCH_SORTIR_DATA' | 'ADMIN_DATA' | 'SKU_DATA' | 'SPECIAL_SCAN' | 'SEARCH_ALL_FIRESTORE' | 'FIRESTORE_MANAGER' | 'SUPABASE_MANAGER' | 'RUNNING_TEXT_MANAGER' | 'TRACK_RESI' | 'ADMIN_NOTES' | 'INJECT_EXPIRED_RESI' | 'PRINT_FORMS' | 'ADMIN_BATCH_IMPORTS' | 'MENU_VISIBILITY' | 'RESI_FORMATTER';
